...
import rospy
from path_planning_vrep_simulation.msg import FieldObjects as FieldObjects_msg, Path, AllPathes
from path_planning_vrep_simulation.Planner import Paths_planner
