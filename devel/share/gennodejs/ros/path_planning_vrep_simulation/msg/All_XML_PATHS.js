...
class All_XML_PATHS {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.paths.forEach((val) => {
      bufferOffset = XML_PATH.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    object.paths.forEach((val) => {
      length += XML_PATH.getMessageSize(val);
    });
    return length + 4;
  }
