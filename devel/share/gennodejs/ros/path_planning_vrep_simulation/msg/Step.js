...
class Step {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Point2d.serialize(obj.finish, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.finish = Point2d.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.finish !== undefined) {
      resolved.finish = Point2d.Resolve(msg.finish)
    }
    else {
      resolved.finish = new Point2d()
    }
